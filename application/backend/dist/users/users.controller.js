...
__decorate([
    (0, common_1.Put)('me/upgrade-to-organizer'),
    (0, swagger_1.ApiOperation)({ summary: 'Upgrade user role to organizer' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Role upgraded successfully' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'User is already an organizer' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
