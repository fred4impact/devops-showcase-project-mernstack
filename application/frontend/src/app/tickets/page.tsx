      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {tickets.length === 0 ? (
          <Card className="p-12 text-center">
            ...
            <p className="text-gray-500 mb-6">You haven't purchased any tickets yet. Start exploring events!</p>
            <Button
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        ...
                        <p className="text-gray-600 mb-2">{ticket.order.event.description}</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t border-gray-200">
                      <div>
                        ...
                        <p className="text-gray-900">{ticket.ticketType.name}</p>
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700">Price</label>
                        <p className="text-gray-900">${ticket.ticketType.price.toFixed(2)}</p>
                      </div>
                      {ticket.seatNumber && (
                        <div>
                    ...
                    {ticket.qrCode && (
                      <Button
                        onClick={() => {
                          ...
                          window.open(`data:image/png;base64,${ticket.qrCode}`, '_blank');
                        }}
                        variant="outline"
                        className="w-full lg:w-auto"
                      >
