          ...
          <div>
            ...
            {(orders || []).length === 0 ? (
              <Card className="p-6 text-center">
                ...
                <p className="text-gray-500 mb-4">Start exploring events and purchase tickets</p>
                <Button
                  onClick={() => router.push('/events')}
                  className="bg-primary-600 hover:bg-primary-700"
                >
              ...
              <div className="space-y-4">
                {(orders || []).map((order) => (
                  <Card key={order._id} className="p-6">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-gray-900 mb-2">{order.event.title}</h3>
                        <p className="text-gray-600 mb-2">{order.event.description}</p>
                        <div className="flex items-center text-sm text-gray-500 mb-2">
                          <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                          </svg>
